                ...
                <div className="mt-8 border-t border-slate-800 pt-6">
                  ...
                  {assessmentData.weather && (
                    <div className="mt-4 grid gap-4 sm:grid-cols-3">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-lg font-semibold">
                          {assessmentData.weather.precipitation_mm} mm
                        </p>
                      </div>
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-lg font-semibold">
                          {Math.round(
                            assessmentData.weather.visibility_m / 1000,
                          )}{" "}
                          km
                        </p>
                      </div>
                  ...
                  <div className="mt-6">
                    ...
                    <p className="mt-2 text-sm text-slate-300">
                      {assessmentData.nearby_places.filter(
                        (place) => place.category === "hospital",
                      ).length}{" "}
                      hospitals and{" "}
                      {assessmentData.nearby_places.filter(
                        (place) => place.category === "pharmacy",
                      ).length}{" "}
                  ...
                  <div className="mt-4">
                    ...
                    <div className="mt-2 flex flex-wrap gap-2">
                      {assessmentData.data_sources.map((source) => (
                        <span
                          key={source}
